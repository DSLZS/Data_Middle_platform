      ...
      <el-col :span="24" class="mb10">
        <el-card>
          <template #header>
            ...
            <span style="vertical-align: middle" class="ml5">基本信息</span>
          </template>
      ...
      <el-col v-bind="layout" class="mb10">
        <el-card>
          <template #header>
            ...
            <span style="vertical-align: middle" class="ml5">命令统计</span>
          </template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
      ...
      <el-col v-bind="layout" class="mb10">
        <el-card>
          <template #header>
            ...
            <span style="vertical-align: middle" class="ml5">内存信息</span>
          </template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
