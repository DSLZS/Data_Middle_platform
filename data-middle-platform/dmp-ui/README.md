...
1. 本项目可以完美的对接原版本的dmp前后端分离版本的后端

2. 本项目重构了若依前后端分离版本的前端70%的代码，代码高度内聚，并优化了界面的ui。

3. 提供了技术栈<a href="https://gitee.com/codelm/dmp-vue3-lmw">vue3+js</a> 版本，保持同步更新。

## 联系本人

本人微信：di_huhu，欢迎大家提供建议，
...
```bash
# 克隆项目
git clone https://gitee.com/codelm/dmp-vue3-lmw.git
